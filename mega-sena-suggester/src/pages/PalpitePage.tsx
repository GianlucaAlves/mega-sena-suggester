            ...
            >
                ...
                >
                    ...
                    <p style={{ margin: 0, color: COLORS.textoSecundario, fontSize: 17, lineHeight: 1.6, maxWidth: 760 }}>
                        Aqui você escolhe o fluxo: pedir uma sugestão aleatória ou selecionar manualmente 6 dezenas em um volante moderno inspirado na Mega-Sena.
                    </p>
                </section>
                ...
                >
                    ...
                    >
                        <div>
                            ...
                            <h2 style={{ margin: '8px 0 10px', color: COLORS.branco, fontSize: 28, fontWeight: 900 }}>
                                Gerador rápido
                            </h2>
                            <p style={{ margin: 0, color: COLORS.textoSecundario, lineHeight: 1.6 }}>
                        ...
                        >
                            {palpite ? (
                                <>
                                    <span style={{ color: COLORS.textoSecundario, fontSize: 13, textTransform: 'uppercase', letterSpacing: 1.2 }}>
                                        Último palpite gerado
                                    </span>
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 52px)', justifyContent: 'center', gap: 12 }}>
                                ...
                                <p style={{ margin: 0, color: COLORS.textoSecundario, textAlign: 'center', lineHeight: 1.6 }}>
                                    Gere uma combinação automática para visualizar suas dezenas aqui.
                                </p>
                            )}
                        </div>
                    </div>
